...
<template>
		<nav class="relative flex flex-wrap items-center justify-between px-0 pt-4 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start" navbar-main navbar-scroll="false">
				...
				<div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
					...
					<ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
						<li class="flex items-center">
							<button class="block px-0 py-2 text-sm font-semibold text-white transition-all ease-nav-brand" @click="signOut">
