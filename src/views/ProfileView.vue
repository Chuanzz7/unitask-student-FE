		...
		<div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
			...
			<div class="flex-auto p-6">
				...
				<div class="flex flex-wrap -mx-3">
					<TextInput v-model="state.username" :disabled="!editable" label="Username" class="w-full max-w-full px-3 shrink-0 md:w-5/12 md:flex-0"></TextInput>
					<TextInput disabled v-model="state.email" label="Email Address" class="w-full max-w-full px-3 shrink-0 md:w-5/12 md:flex-0"></TextInput>
				...
				<div class="flex flex-wrap -mx-3">
					<TextInput :disabled="!editable" type="password" v-model="state.oldPassword" label="Old Password" class="w-full max-w-full px-3 shrink-0 md:w-5/12 md:flex-0"></TextInput>
					<TextInput :disabled="!editable" label="New Password" type="password" v-model="state.newPassword" class="w-full max-w-full px-3 shrink-0 md:w-5/12 md:flex-0"></TextInput>
					<div v-if="editable" class="px-8 md:w-2/12">
